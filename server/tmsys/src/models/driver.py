...
class Driver(db.Model):
    ...
    driver_status = db.Column(db.Enum(DriverStatus), server_default="not_assigned")
    ...
    def __init__(self, driver_firstname, driver_lastname, driver_phone, driver_email, driver_licence):
